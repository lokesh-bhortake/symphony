...
const Categories = () => {
    ...
    return (
        <>
            <div
                className={`${styles.flexCenter} mt-20 bg-pattens-blue-900 p-4`}
            >
                <div className="flex flex-col justify-center items-center w-full 2xl:max-w-7xl gap-4">
                    <div className="flex flex-col h-20 w-full items-start p-2 justify-center bg-pattens-blue-200">
                        <h2 className="font-bold text-xl">
                            {capitalizeFirstLetter(category)}
                        </h2>
                    </div>
                    <div className="flex flex-col bg-pattens-blue-100 w-full p-2">
